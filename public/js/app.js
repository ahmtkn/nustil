...
__webpack_require__(/*! ./drag-n-drop */ "./resources/js/drag-n-drop.js");
...
var _loop = function _loop(i) {
  ...
  dropArea.addEventListener('drop', function (e) {
    ...
    _toConsumableArray(e.dataTransfer.files).forEach(previewImage);

    dropArea.querySelector('input').files = e.dataTransfer.files;
  }, false);
  dropArea.querySelector('input').addEventListener('change', function (e) {
    dropArea.classList.add('dropped');

    _toConsumableArray(e.target.files).forEach(previewImage);
  }, false);
};
